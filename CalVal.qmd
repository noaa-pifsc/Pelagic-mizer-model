# Calibration and Diagnostic Evaluation {#sec-CalVal}
...
Black lines represent observed catch at size (with circles used for sharks 
because their lengths are reported in feet rather than cm, which leads to 
otherwise blocky plots).  Colors represent different parameter choices as 
