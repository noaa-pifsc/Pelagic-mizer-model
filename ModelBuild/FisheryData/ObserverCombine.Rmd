...
# Keep a record with just set-level details, to make mapping easier
Obs_Details_HIonly <- ObservedSetDetails_allSets |>
  filter(str_starts(TRIP_NUM, "LL") & is.na(EXPR_TRIP_TYPE_ID))
```
...
saveRDS(object = Obs_Details_HIonly, file = here("ModelBuild", "FisheryData", "Obs_Details_HIonly.rds"))
write_csv(Obs_Details_HIonly, file = here("ModelBuild", "FisheryData", "Obs_Details_HIonly.csv"))
```
