...
# Plot
hist(log10(bye_PPMR), freq = FALSE)
lines(density(log10(bye_PPMR)))
abline(v = log10(bye_beta), col = "darkgreen", lwd = 2)
lines(x = c(bye_PPMR_quartiles_log10[[2]], bye_PPMR_quartiles_log10[[4]]), y = c(0.25, 0.25), col = "darkgreen", lwd = 2)
```
...
hist(log10(swd_PPMR), freq = FALSE)
lines(density(log10(swd_PPMR)))
abline(v = log10(swd_beta), col = "darkgreen", lwd = 2)
lines(x = c(swd_PPMR_quartiles_log10[[2]], swd_PPMR_quartiles_log10[[4]]), y = c(0.25, 0.25), col = "darkgreen", lwd = 2)
```
```{r}
# Yellowfin tuna
...
hist(log10(yft_PPMR), freq = FALSE)
lines(density(log10(yft_PPMR)))
abline(v = log10(yft_beta), col = "darkgreen", lwd = 2)
lines(x = c(yft_PPMR_quartiles_log10[[2]], yft_PPMR_quartiles_log10[[4]]), y = c(0.25, 0.25), col = "darkgreen", lwd = 2)
```
...
hist(log10(alb_PPMR), freq = FALSE)
lines(density(log10(alb_PPMR)))
abline(v = log10(alb_beta), col = "darkgreen", lwd = 2)
lines(x = c(alb_PPMR_quartiles_log10[[2]], alb_PPMR_quartiles_log10[[4]]), y = c(0.25, 0.25), col = "darkgreen", lwd = 2)
```
...
hist(log10(fish_PPMR), freq = FALSE)
lines(density(log10(fish_PPMR)))
abline(v = log10(fish_beta), col = "darkgreen", lwd = 2)
lines(x = c(fish_PPMR_quartiles_log10[[2]], fish_PPMR_quartiles_log10[[4]]), y = c(0.25, 0.25), col = "darkgreen", lwd = 2)
```
...
hist(log10(sharks_PPMR), freq = FALSE)
lines(density(log10(sharks_PPMR)))
abline(v = log10(sharks_beta), col = "darkgreen", lwd = 2)
lines(x = c(sharks_PPMR_quartiles_log10[[2]], sharks_PPMR_quartiles_log10[[4]]), y = c(0.25, 0.25), col = "darkgreen", lwd = 2)
```
...
hist(log10(rays_PPMR), freq = FALSE)
lines(density(log10(rays_PPMR)))
abline(v = log10(rays_beta), col = "darkgreen", lwd = 2)
lines(x = c(rays_PPMR_quartiles_log10[[2]], rays_PPMR_quartiles_log10[[4]]), y = c(0.25, 0.25), col = "darkgreen", lwd = 2)
```