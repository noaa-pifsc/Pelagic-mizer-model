...
# png(here("ModelBuild", "OceanographicData", "ocean_domain_map.png"), bg = "transparent")
# ocean_domain_map
# dev.off()
...
ocean_domain_map_Q1 <- ggplot() +
  ...
  coord_quickmap(c(150, 250), ylim = c(-25, 50)) +
  annotation_borders("world2", fill = "#A5AAAF")
# png(here("ModelBuild", "OceanographicData", "ocean_domain_map_Q1.png"), bg = "transparent")
# ocean_domain_map_Q1
# dev.off()
...
ocean_domain_map_Q2 <- ggplot() +
  ...
  coord_quickmap(c(150, 250), ylim = c(-25, 50)) +
  annotation_borders("world2", fill = "#A5AAAF")
# png(here("ModelBuild", "OceanographicData", "ocean_domain_map_Q2.png"), bg = "transparent")
# ocean_domain_map_Q2
# dev.off()
...
ocean_domain_map_Q3 <- ggplot() +
  ...
  coord_quickmap(c(150, 250), ylim = c(-25, 50)) +
  annotation_borders("world2", fill = "#A5AAAF")
# png(here("ModelBuild", "OceanographicData", "ocean_domain_map_Q3.png"), bg = "transparent")
# ocean_domain_map_Q3
# dev.off()
...
ocean_domain_map_Q4 <- ggplot() +
  ...
  coord_quickmap(c(150, 250), ylim = c(-25, 50)) +
  annotation_borders("world2", fill = "#A5AAAF")
# png(here("ModelBuild", "OceanographicData", "ocean_domain_map_Q4.png"), bg = "transparent")
# ocean_domain_map_Q4
# dev.off()
```
