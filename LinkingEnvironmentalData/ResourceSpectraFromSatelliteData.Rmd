...
[online](https://github.com/pwoodworth-jefcoats/therMizer-WCPFC/tree/main/PlanktonFunction).
If you have your own data ready to go, you can skim the script
and jump to the `SATspectrum` and `plankton_forcing` functions.  And, if you have 
questions or need a hand, please [open an issue](https://github.com/noaa-pifsc/Pelagic-mizer-model/issues). 
...
fishery, whose operating footprint includes the oligotrophic North Pacific.  A 
...
questions about how to tackle this piece, there's code available 
[online](https://github.com/pwoodworth-jefcoats/therMizer-WCPFC/tree/main/PlanktonSize).
You can also [open an issue](https://github.com/noaa-pifsc/Pelagic-mizer-model/issues)
with any questions.

#### Data provided
The following data are included in [this folder](https://github.com/pwoodworth-jefcoats/therMizer-WCPFC/tree/main/PlanktonFunction) 
and used to run this script: 
...
folder for details on its implementation.  
...
and requires iterative trial and error.  
