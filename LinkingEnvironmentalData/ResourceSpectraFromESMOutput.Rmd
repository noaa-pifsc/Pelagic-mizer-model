...
`plankton_forcing`, for forcing your mizer model with the ESM-derived resource
...
piece, you can [open an issue](https://github.com/noaa-pifsc/Pelagic-mizer-model/issues).
